...
> **Live site:** set `VITE_DEPLOY_URL` in your `.env` file to the URL where this instance is deployed (e.g. `VITE_DEPLOY_URL=https://suparbox.example.com`). The deployed site can then be accessed at that URL.
